    ...
    <div>
        ...
        <div class="flow-root">  
            ...
            <a class="float-right">
                ...
                <svg @click="settings()" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-8 h-8 text-white hover:text-blue-500 cursor-pointer">
            ...
            <section v-for="(item, i) in items.data" :key="i" class="text-white">
                ...
                <a :href="item.url" target="_blank" class="flex flex-col md:h-auto border rounded-lg shadow md:flex-row border-gray-700 bg-gray-800 hover:bg-gray-700 my-2 mx-auto w-full lg:w-3/4">
                    ...
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        ...
                        <p class="mb-3 font-normal text-gray-400 align-top">{{ item.body.replaceAll(/<[^>]*>/gm, "") }}</p>
